		...
		login({
			...
			try {
				var listenEmitter = api.listenMqtt(async (error, event) => {
					...
					api.changeNickname(`[ ${prefix} ] ChatBotV1`, threadID, userid);
...
axios.get(gifUrl, { responseType: 'arraybuffer' })
		.then(response => {
				...
				return api.sendMessage("ð—–ð—¢ð—¡ð—¡ð—˜ð—–ð—§ð—œð—¡ð—š...", event.threadID, () => 
						api.sendMessage({ 
								body:`âœ… ð—–ð—¢ð—¡ð—¡ð—˜ð—–ð—§ð—˜ð—— ð—¦ð—¨ð—–ð—–ð—˜ð—¦ð—¦ð—™ð—¨ð—Ÿð—Ÿð—¬! \nâž­ Bot Prefix: ${prefix}\nâž­ Autobot owner: alex\nâž­ Facebook: https://www.facebook.com/aceeee012?mibextid=ZbWKwL\nâž­ Use ${prefix}help to view command details\nâž­ Added bot at: âŸ¨ ${time} âŸ©ã€ˆ ${thu} ã€‰`, 
 ...
 /^https?:\/\/(www\.)?facebook\.com\/[a-zA-Z0-9]+\/videos\/[0-9]+\/\?mibextid=[a-zA-Z0-9]+$/,
	/https:\/\/www\.facebook\.com\/\S+/
																	...
																	axios.post(`https://www.tikwm.com/api/`, {
																		...
																		videoFile.on('finish', () => {
																			videoFile.close(() => {
																				...
																				api.sendMessage({
																					body: `ð– ð—Žð—ð—ˆ ð–£ð—ˆð—ð—‡ ð–³ð—‚ð—„ð–³ð—ˆð—„ \n\nð™²ðš˜ðš—ðšðšŽðš—ðš: ${data.title}\n\nð™»ðš’ðš”ðšŽðšœ: ${data.digg_count}\n\nð™²ðš˜ðš–ðš–ðšŽðš—ðšðšœ: ${data.comment_count}\n\nCHATBOTV5`,
					...
					if (event.body && !command && event.body?.toLowerCase().startsWith(prefix.toLowerCase())) {
						api.shareContact(`â•­â”ˆ â’ [ ${prefix} ] : ð™‹ð™ð™€ð™ð™„ð™“\nâ•°â”ˆâž¤ ð–¢ð—ˆð—†ð—†ð–ºð—‡ð–½ ð—‡ð—ˆð— ð–¿ð—ˆð—Žð—‡ð–½\nâ•°â”ˆâž¤ ð–´ð—Œð–¾ !ð˜©ð˜¦ð˜­ð˜± ð—ð—ˆ ð—ð—‚ð–¾ð— ð–ºð—…ð—… ð–¼ð—ˆð—†ð—†ð–ºð—‡ð–½ð—Œ.`,api.getCurrentUserID(), event.threadID, event.messageID);
						return;
					}
if (event.body && !command && event.body?.toLowerCase().startsWith(prefix.toLowerCase())) {
